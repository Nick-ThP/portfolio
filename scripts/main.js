...
document.getElementById('change-color').addEventListener('click', () => {
	document.documentElement.style.setProperty('--interface-accent-color', `hsl(${getRandomNumber()}, 100%, 50%)`)
})
...
const opacityIn = (number) => {
	...
	document.getElementsByClassName('overlay-text')[number].style.opacity = 0.2
}
